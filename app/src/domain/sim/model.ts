...
/**
 * Kartenmodell für die Kampf-Sim (engine2). Leitet aus den ECHTEN Kartendaten ab,
 * was belegbar ist: Grundwerte (cost/power/type), Kampf-Keywords und die
 ...
 * abstrahiert. Wir lesen NUR imperative Sätze (Programme ganz; Einheiten die
 ...
 *
 * rules_text steckt bereits in der lokalen `cards.json` (wie bei der Synergie);
 * hier wird es nur ausgelesen, nichts verteilt.
 */
...
export interface CardModel {
  ...
  eddieSource: boolean;
  /** Effekt beim Spielen (Programme sofort; Einheiten via {Play}). */
  onPlay: Effect;
